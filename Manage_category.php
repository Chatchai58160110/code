...
<head>
	...
	<script type="text/javascript">
		...
		$(document).on("click", ".btn-warning", function () 
		{
		  ...
		  $(".modal-body #Cat_idd").val( id );
		  $(".modal-body #Cat_id").val( id );
		  $(".modal-body #Cat_name ").val( name );
		});
...
<body>
	...
	if(isset($_REQUEST['save'])){
		...
		if($check === ''){
			$sql_a = 	"insert into category_ (Cat_id,Cat_name)
							VALUES ('$Cat_id','$Cat_name')";
			$insert_cat =$conn->query($sql_a);
		}
	}					
	?>	
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row" style="margin-bottom: 10px;">	
						<label class="col-sm-4" style="padding-top: 7px; margin-left: 50px;">รหัสหมวดหมู่</label>
						<div class="col-xs-4"><input name="Cat_idd" id="Cat_idd" class="form-control" required="" type="text" placeholder="กรอกรหัสหมวดหมู่" data-parsley-minlength="6"  disabled></div>
						<input name="Cat_id" id="Cat_id" style="display:none;" class="form-control" required="" type="text"  data-parsley-minlength="6">
					</div>
					<div class="row" style="margin-bottom: 10px;">	
						<label class="col-sm-4" style="padding-top: 7px; margin-left: 50px;">ชื่อหมวดหมู่</label>
						<div class="col-xs-4"><input name="Cat_name" id="Cat_name" class="form-control" required="" type="text" placeholder="กรอกชื่อหมวดหมู่" data-parsley-minlength="6"></div>
					</div>
				</div>
				...
				<?php 
					if(isset($_REQUEST['bt_up'])){
						...
						echo $Cat_id;
						echo $Cat_name;
						$sql_upc = "Update category_ Set Cat_name = '$Cat_name'
									where Cat_id = '$Cat_id' ";
						$insert_upc =$conn->query($sql_upc);
					}
				?>
